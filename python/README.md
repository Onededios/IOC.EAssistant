...
The web API provides a **stateless** RESTful interface for the IOC.EAssistant chatbot powered by RAG (Retrieval-Augmented Generation). The API uses LangChain with Ollama models for embeddings and chat completion, and ChromaDB for vector storage.
